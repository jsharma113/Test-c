...
$(document).ready(function() {
	...
	$.ajax({
	 ...
	 success: function(posts) {
	 	...
	 	row += '<thead><tr><th>ID</th><th>User ID</th><th>Title</th><th>Body</th></tr></thead><tbody>';
	 	for(let i = 0; i < posts.length; i++)
	 	{
	 		...
	 		row += '<tr '+green+'><td>'+data[i].id+'</td><td>'+data[i].userId+'</td><td>'+data[i].title+'</td><td>'+data[i].body+'</td></tr>';
